                            ...
                            <div class="classynav">
                                ...
                                <div class="top-search-area">
                                    <form action='search/search.php' method="POST">
                                        <input type="text" id="name" name="name" class="form-control" placeholder="Search and hit enter...">
                ...
                <div class="poca-projects-menu mb-30 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="text-center portfolio-menu">
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ?>         
                            <button class="btn" data-filter=".<?= $row[0] ?>"><?= $row[1] ?></button>
                            <?php
                        }
                        ?>
                    </div>
            ...
            <div class="container">
                <div class="row poca-portfolio">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <?php
                        include 'CheckConnect.php';
                        $query1 = "SELECT* FROM tblcategory WHERE _idC='$idC'";
                        $result1 = mysqli_query($conn, $query1);
                        while ($row1 = mysqli_fetch_array($result1)) {
                            ?>
                            <div class="col-12 col-md-6 single_gallery_item <?= $row1[0] ?> wow fadeInUp article " data-wow-delay="0.2s">
                                <!-- Welcome Music Area -->
                                <div class="poca-music-area style-2 d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="poca-music-content text-center">
                                        ...
                                        <div class="music-meta-data">
                                            <p>By <a href="#" class="music-author">Admin</a> | <a href="#" class="music-catagory"><?= $row1[1] ?></a></p>
                                        </div>
